    ...
    public partial class TelaTarefaForm : Form
    {
        ...
        public Tarefa Tarefa
        {
            ...
            set
            {
                ...
                cbPrioridade.SelectedItem = value.Prioridade;
            }
        }
        ...
        private void CarregarPrioridades()
        {
            ...
            foreach (var valor in valoresEnum)
                cbPrioridade.Items.Add(valor);

            cbPrioridade.SelectedItem = PrioridadeTarefaEnum.Baixa;
        }
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            PrioridadeTarefaEnum prioridade =
                (PrioridadeTarefaEnum)cbPrioridade.SelectedItem;
